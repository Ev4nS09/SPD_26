...
public class bin_m2{
	...
	dec evt_dec = new dec(this);
	found evt_found = new found(this);
	inc evt_inc = new inc(this);
	...
	public static final Integer n = Test_bin_m2.random_n;

	//@ public static constraint v.equals(\old(v)); 
	public static final Integer v = Test_bin_m2.random_v;
